...
function Ventas() {
    ...
    const verDetalleTicket = (ticket) => {
        ...
        fetch(`https://correction-escape-inquiry-investments.trycloudflare.com/api/detalle-ticket?sucursal=${encodeURIComponent(ticket.Sucursal)}&numero_fiscal=${ticket.NumeroFiscal}`, {
            method: 'GET',
            headers: {
